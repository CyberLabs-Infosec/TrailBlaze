...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9456)), "/home/atish/trailBlaze/client/app/login/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3075)), "/home/atish/trailBlaze/client/app/login/layout.tsx"],
    ...
    const pages = ["/home/atish/trailBlaze/client/app/login/page.tsx"];
...
function RegisterPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        const resp = await react_toastify__WEBPACK_IMPORTED_MODULE_5__/* .toast */ .Am.promise(fetch("/api/auth/login", {
            method: "POST",
            body: JSON.stringify({
                loginMethod: "regular",
                loginEmail: email,
        ...
        if (jsonResp.status == "fail") {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_5__/* .toast */ .Am.success("Welcome!");
            router.push("/");
        }
    };
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        if (code != null) {
            const getData = async ()=>{
                const result = await react_toastify__WEBPACK_IMPORTED_MODULE_5__/* .toast */ .Am.promise(fetch("/api/auth/login", {
                    method: "POST",
                    body: JSON.stringify({
                        loginMethod: "google",
                        code: code
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/atish/trailBlaze/client/app/login/layout.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/atish/trailBlaze/client/app/login/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [666,817], () => (__webpack_exec__(455)));
