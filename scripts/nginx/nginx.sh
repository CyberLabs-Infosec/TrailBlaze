...
sudo cp ~/TrailBlaze/scripts/nginx/trailblaze.conf ~/TrailBlaze/scripts/nginx/admin.conf ~/TrailBlaze/scripts/nginx/inspect.conf ~/TrailBlaze/scripts/nginx/checksum.conf ~/TrailBlaze/scripts/nginx/revjs.conf ~/TrailBlaze/scripts/nginx/maxxor.conf ~/TrailBlaze/scripts/nginx/overflow.conf ~/TrailBlaze/scripts/nginx/readme.conf ~/TrailBlaze/scripts/nginx/cookie.conf ~/TrailBlaze/scripts/nginx/jwt.conf ~/TrailBlaze/scripts/nginx/bluff.conf /etc/nginx/sites-available
...
sudo ln -s /etc/nginx/sites-available/checksum.conf /etc/nginx/sites-enabled
